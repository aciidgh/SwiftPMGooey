...
func connectSignal<T>(_ instance: UnsafeMutablePointer<T>, name: String, data: UnsafePointer<Void>, connectFlags: ConnectFlags = .After, handler: GCallback) -> UInt {
    return g_signal_connect_data(instance, name, handler, UnsafeMutablePointer(data), nil, connectFlags.toGConnectFlags())
}

func connectSignal<T>(_ instance: UnsafeMutablePointer<T>, name: String, connectFlags: ConnectFlags = .After, handler: GCallback) -> UInt {
