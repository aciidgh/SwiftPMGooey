...
public class Widget {    
    ...
    func addSignal(_ name: String, callback: SignalCallbackZero) {
        ...
        let handlerId = connectSignal(widgetPointer, name: name, data: unsafeAddress(of: box), handler: unsafeBitCast(handler, to: GCallback.self))
        
        signals.append((handlerId, box))
    }
    
    func addSignal(_ name: String, callback: SignalCallbackOne) {
    ...
    func addSignal(_ name: String, callback: SignalCallbackTwo) {
    ...
    func addSignal(_ name: String, callback: SignalCallbackThree) {
    ...
    func addSignal(_ name: String, callback: SignalCallbackFour) {
    ...
    func addSignal(_ name: String, callback: SignalCallbackFive) {
    ...
    func addSignal(_ name: String, callback: SignalCallbackSix) {
